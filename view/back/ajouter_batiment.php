...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $controller->add($_POST['nom'], $_POST['adresse'], $_POST['nombre_etages'], $_POST['description']);
...
<body>
    ...
    <main class="main-content">
        <div class="top-nav">
            <h2 style="font-size:18px;color:#381d51;">Ajouter un Bâtiment</h2>
            <a href="batiments.php"><i class="fas fa-arrow-left"></i> Retour</a>
        </div>
        <div class="form-container">
            <?php if (!empty($errors)): ?>
                <div class="error" style="color:red;background:#f8d7da;padding:10px;border-radius:4px;margin-bottom:15px;">
            ...
            <form method="POST" onsubmit="return validateForm(event)">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nombre_etages" id="nombre_etages" class="form-control" value="1">
                </div>
                <div class="form-group">
