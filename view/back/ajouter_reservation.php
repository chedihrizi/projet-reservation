...
$utilisateurs = $userCtrl->getAll();
$salles = $salleCtrl->getAllDisponibles();

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $resCtrl->add($_POST['id_utilisateur'], $_POST['id_salle'], $_POST['date_reservation'], $_POST['heure_debut'], $_POST['heure_fin'], $_POST['objet']);
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php else: ?>
            <li><a href="gestion_reservations.php" style="color:inherit;text-decoration:none;"><i class="fas fa-calendar-check"></i> Réservations</a></li>
            <li style="background-color:#602299;"><a href="ajouter_reservation.php" style="color:inherit;text-decoration:none;"><i class="fas fa-plus-circle"></i> Nouvelle Réservation</a></li>
            <?php endif; ?>
    ...
    <main class="main-content">
        <div class="top-nav">
            <h2 style="font-size:18px;color:#381d51;">Nouvelle Réservation</h2>
            ...
            <form method="POST" onsubmit="return validateForm(event)">
                ...
                <div class="form-group">
                    ...
                    <select name="id_salle" id="id_salle" class="form-control">
                        ...
                        <option value="<?php echo $s['id']; ?>"><?php echo htmlspecialchars($s['nom'] . ' - ' . $s['nom_batiment'] . ' (Cap: ' . $s['capacite'] . ')'); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="objet" id="objet" class="form-control" placeholder="Ex: Réunion d'équipe, Formation...">
                </div>
    ...
    function validateForm(event) {
        var u = document.getElementById('id_utilisateur').value;
