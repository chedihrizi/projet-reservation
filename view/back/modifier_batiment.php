...
$batiment = $controller->getById($id);

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $controller->update($id, $_POST['nom'], $_POST['adresse'], $_POST['nombre_etages'], $_POST['description']);
    if ($result === true) { header('Location: batiments.php'); exit(); }
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li style="background-color:#602299;"><a href="batiments.php" style="color:inherit;text-decoration:none;"><i class="fas fa-building"></i> Bâtiments</a></li>
    ...
    <main class="main-content">
        <div class="top-nav">
            <h2 style="font-size:18px;color:#381d51;">Modifier le Bâtiment</h2>
            <a href="batiments.php"><i class="fas fa-arrow-left"></i> Retour</a>
        </div>
        <div class="form-container">
            ...
            <form method="POST" onsubmit="return validateForm(event)">
                <div class="form-group">
                    <label>Nom</label>
                    <input type="text" name="nom" id="nom" class="form-control" value="<?php echo htmlspecialchars($batiment['nom']); ?>">
                </div>
                <div class="form-group">
                    <label>Adresse</label>
                    <input type="text" name="adresse" id="adresse" class="form-control" value="<?php echo htmlspecialchars($batiment['adresse']); ?>">
                </div>
                <div class="form-group">
                    <label>Nombre d'étages</label>
                    <input type="number" name="nombre_etages" id="nombre_etages" class="form-control" value="<?php echo $batiment['nombre_etages']; ?>">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <textarea name="description" id="description" class="form-control" rows="3"><?php echo htmlspecialchars($batiment['description']); ?></textarea>
                </div>
                <div class="form-buttons">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Enregistrer</button>
                    <a href="batiments.php" class="btn btn-danger"><i class="fas fa-times"></i> Annuler</a>
                </div>
            </form>
        </div>
    </main>
    ...
    function validateForm(event) {
        if (!document.getElementById('nom').value.trim() || !document.getElementById('adresse').value.trim()) {
