...
$utilisateurs = $controller->getAll();
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .role-admin { background-color: #e8d5f5; color: #602299; }
        .role-gestionnaire { background-color: #d5e8f5; color: #1565C0; }
        .role-utilisateur { background-color: #d5f5e8; color: #155724; }
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="utilisateurs.php"><i class="fas fa-users"></i> <span>Utilisateurs</span></a></li>
    ...
    <main class="main-content">
        <div class="top-nav">
            <div class="page-title"><h1>Gestion des Utilisateurs</h1></div>
        </div>

        <div class="content-section">
            <div class="section-header">
                <h2>Liste des Utilisateurs</h2>
                <a href="ajouter_utilisateur.php" class="btn btn-primary"><i class="fas fa-plus"></i> Nouvel Utilisateur</a>
            </div>
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="modifier_utilisateur.php?id=<?php echo $u['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                            <button onclick="confirmDelete(<?php echo $u['id']; ?>)" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
